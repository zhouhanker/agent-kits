...
def _parser() -> argparse.ArgumentParser:
    ...
    agents = subparsers.add_parser("agents", help="inspect analysis-provider and sandbox prerequisites")
    agents_sub = agents.add_subparsers(dest="agents_command", required=True)
    agents_sub.add_parser("list", help="list local Agents, model API readiness, and sandboxes without using a model")
    agent_check = agents_sub.add_parser("check", help="prove one selected analysis provider can complete a constrained model call")
    ...
    source = subparsers.add_parser("source", help="inspect, quarantine, or intake untrusted sources")
    ...
    intake = source_sub.add_parser("intake", help="analyze and validate a source with a selected provider")
    ...
    install = subparsers.add_parser("install", help="install a registry-declared component with a current validation receipt")
